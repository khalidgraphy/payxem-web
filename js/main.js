...
(function () {
  ...
  // Uses a simple scroll listener with requestAnimationFrame for
  // maximum reliability across all browsers and scroll behaviors.
  ...
  // Check on load and after a short delay for layout settling
  checkReveals();
